...
- `AppNavigation`, settings-responsive font scaling, search, word detail, and future modal shells must consume that same source.
...
- Create:
  ...
  - `UI_AUDIT.md`
  - `WEB_UI_CONTRACT.md`
- Append the continuity decision to `PHONE_PLAN_AGENT_LOG.md`
