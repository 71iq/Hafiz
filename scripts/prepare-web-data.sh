...
mkdir -p public/data/tafseer public/data/tafsir-sources/tahrir-tanwir public/data/tafsir-sources/qurtubi public/data/tafsir-sources/kashshaf public/data/tafsir-sources/alusi public/data/tafsir-sources/nazam-durar public/data/tafsir-sources/razi public/data/tafsir-sources/al-bahr-al-madid public/data/tafsir-sources/jalalayn public/data/tafsir-sources/jalalayn-en public/data/translations public/data/wbw public/data/masaq public/data/layout public/data/mutashabihat
...
cp assets/data/tafsir-sources/razi/*.json public/data/tafsir-sources/razi/
cp assets/data/tafsir-sources/al-bahr-al-madid/*.json public/data/tafsir-sources/al-bahr-al-madid/
