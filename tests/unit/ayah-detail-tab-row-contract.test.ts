...
describe("AyahDetailModal tab row contract", () => {
  it("keeps ayah detail tabs in one horizontally scrollable row", () => {
    ...
    expect(source).not.toContain('className="mt-4 flex-row flex-wrap gap-2"');
  });
});
